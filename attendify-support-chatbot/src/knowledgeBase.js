...
- Instagram: \`https://www.instagram.com/heheshivam/\`.
- LinkedIn: \`https://www.linkedin.com/in/shivam-kumar-mahto-046228361/\`.
- **AI Support**: A dedicated chatbot card linking to the live Netlify application: \`https://attendify-support-chatbot.netlify.app\`.

The email card copies the email address to clipboard and triggers a toast message. Other cards (Instagram, LinkedIn, AI Support) open directly in a new tab.
