...
export default function ChatWidget({
  ...
  const [messages, setMessages] = useState<Message[]>(() => {
    try {
      const stored = localStorage.getItem("attendify_chat_history");
      if (stored) {
  ...
  useEffect(() => {
    try {
      localStorage.setItem("attendify_chat_history", JSON.stringify(messages));
    } catch (e) {
  ...
  const resetChat = () => {
    ...
    try {
      localStorage.setItem("attendify_chat_history", JSON.stringify(defaultWelcome));
    } catch (e) {
    ...
    <>
      ...
      {(!inlineMode ? isOpen : true) && (
        <div 
          ...
          id="attendify-support-widget-panel"
        >
          {/* Header Panel */}
          <div 
            ...
            <div className="flex items-center gap-2.5 z-10">
              ...
              <div>
                ...
                <div className="text-[10px] text-indigo-100 flex items-center gap-1 mt-0.5">
                  ...
                  <span>AI Agent Online &bull; ATTENDIFY Base</span>
                </div>
              </div>
            </div>
